...
export default function Navbar() {
    ...
    const navItems = (
        <>
            ...
            <NavLink className="mx-3  hover:text-pink-400" to={"/"}><a>Home</a></NavLink>
            <NavLink className="mx-3  hover:text-pink-400" to={"/cource"}><a>Course</a></NavLink>
            <NavLink to={"/contact"} className="mx-3  hover:text-pink-400"><a>Contact</a></NavLink>
            <NavLink className="mx-3  hover:text-pink-400    "><a>About</a></NavLink>

        </>
    );

    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-20 dark:bg-slate-900 dark:text-white px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-900 dark:text-white    duration-300 transition-all ease-out" : ""}`}>
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className=" text-2xl cursor-pointer font-bold">Book Store</a>
                </div>
                <div className="navbar-end space-x-3">
                    ...
                    <div>
                        <NavLink className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={() => document.getElementById('my_modal_3').showModal()}>Login</NavLink>
                        <Login />
